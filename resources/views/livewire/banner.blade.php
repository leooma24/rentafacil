    ...
    <div class="banner-footer">
        <div class="banner-footer-inner banner-footer--1">
            ...
            <div class="banner-footer-content">
                <span class="banner-footer-label">¿Tienes dudas? Llámanos</span>
                <span class="banner-footer-value">668-249-3398</span>
            </div>
        </div>
        <div class="banner-footer-inner banner-footer--2">
            <i class="fas fa-clock"></i>
            <div class="banner-footer-content">
                <span class="banner-footer-label">Horario de atención</span>
                <span class="banner-footer-value">Lun - Vie 08:00 - 17:00</span>
            </div>
        </div>
        <div class="banner-footer-inner banner-footer--3">
            <i class="fas fa-envelope"></i>
            <div class="banner-footer-content">
                <span class="banner-footer-label">Escríbenos</span>
                <a href="mailto:soporte@rentafacil.com" class="banner-footer-value">soporte@rentafacil.com</a>
            </div>
        </div>
    </div>
</section>
